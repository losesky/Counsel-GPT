...
embedding_model_dict = {
    ...
    "text2vec": f"{os.path.dirname(os.path.dirname(__file__))}/embeddings/text2vec-large-chinese",
    # "m3e-small": "moka-ai/m3e-small",
    # "m3e-small": f"{os.path.dirname(os.path.dirname(__file__))}/embeddings/m3e-small",
...
llm_model_dict = {
    ...
    #     "local_model_path": f"{os.path.dirname(os.path.dirname(__file__))}/LLMs/chatglm-6b-int4",
    #     "provides": "ChatGLM"
    # },
    "chatglm2-6b-int4": {
        "name": "chatglm2-6b-int4",
        "pretrained_model_name": "THUDM/chatglm2-6b-int4",
        "local_model_path": f"{os.path.dirname(os.path.dirname(__file__))}/LLMs/chatglm2-6b-int4",
        "provides": "ChatGLM"
    },
    # "chatglm-6b-int8": {
    ...
    # "fastchat-chatglm-6b-int4-qe": {
    #     "name": "chatglm-6b-int4-qe",  # "name"修改为fastchat服务中的"model_name"
